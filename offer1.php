...
<!Doctype html>
 <html>
  ...
  <div class="container">
   <nav class="navbar fixed-top navbar-expand-lg navbar-white p-md-3">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
	  ...
	  <li class="nav-item">
        <a class="nav-link active" id="active" href="#">Sale</a>
      </li>
	  <li class="nav-item">
   ...
   <a class="icon-link" href="cart1.php">
  ...
  <!-- cover -->
  <div class="container mt-5 p-5"  data-aos="zoom-in">
   <img src="image\images.jfif" alt="cover" width="100%" height="400">
  </div>
  
  <!-- Product -->
  
   <div class="container p-4">
    <h3 class="heading" >Shop The <span>Sale</span></h3>      
    <div class="row">
	
    <?php 
     @include 'manage.php';
     $sql="SELECT `title` ,`Information`, `Price`,`Discount`,`image` FROM `product` WHERE Discount>0 ORDER BY ProductId ASC";
